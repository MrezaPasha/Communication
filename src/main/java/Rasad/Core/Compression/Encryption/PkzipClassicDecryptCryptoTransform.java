...
*/
public class PkzipClassicDecryptCryptoTransform extends PkzipClassicCryptoBase implements ICryptoTransform
{
	/** 
	 Initialise a new instance of <see cref="PkzipClassicDecryptCryptoTransform"></see>.
	 
	 @param keyBlock The key block to decrypt with.
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: internal PkzipClassicDecryptCryptoTransform(byte[] keyBlock)
...
//ORIGINAL LINE: public int TransformBlock(byte[] inputBuffer, int inputOffset, int inputCount, byte[] outputBuffer, int outputOffset)
	public final int TransformBlock(byte[] inputBuffer, int inputOffset, int inputCount, byte[] outputBuffer, int outputOffset)
	{
		...
		{
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: byte newByte = (byte)(inputBuffer[i] ^ TransformByte());
