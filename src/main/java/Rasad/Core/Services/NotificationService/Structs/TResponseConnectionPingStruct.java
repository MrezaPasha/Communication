...
//ORIGINAL LINE: [StructLayout(LayoutKind.Explicit)] public struct TResponseConnectionPingStruct
//C# TO JAVA CONVERTER WARNING: Java does not allow user-defined value types. The behavior of this class will differ from the original:
//ORIGINAL LINE: [StructLayout(LayoutKind.Explicit)] public struct TResponseConnectionPingStruct
public final class TResponseConnectionPingStruct
{
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
...
//ORIGINAL LINE: [FieldOffset(0)] private byte dummy;
	...
	//public TResponseConnectionPingStruct()
	//{
	//    this.dummy = 0;
	//}
...
//ORIGINAL LINE: public void setDummy(byte value)
	...
	public TResponseConnectionPingStruct clone()
	{
		TResponseConnectionPingStruct varCopy = new TResponseConnectionPingStruct();
