...
//ORIGINAL LINE: [DataContract][ProtoContract] public class TRequestCloseRemoteServer : TMessageBase
public class TRequestCloseRemoteServer extends TMessageBase
{
	private TRequestCloseRemoteServer()
	{

	}
	public TRequestCloseRemoteServer(String message, int senderID, int receiver)
	{
