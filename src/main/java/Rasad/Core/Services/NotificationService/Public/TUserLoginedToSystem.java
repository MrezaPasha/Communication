...
//ORIGINAL LINE: [DataContract][ProtoContract] public class TUserLoginedToSystem : TMessageBase
public class TUserLoginedToSystem extends TMessageBase
{
	private TUserLoginedToSystem()
	{
	}
	public TUserLoginedToSystem(int userID, String ipAddress, String userInfo, UUID serverInstallationKey)
	{
