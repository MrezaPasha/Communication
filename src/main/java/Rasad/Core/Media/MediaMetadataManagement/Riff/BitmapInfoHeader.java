...
//ORIGINAL LINE: public struct BitmapInfoHeader : IVideoCodec
public final class BitmapInfoHeader implements IVideoCodec
{
...
//ORIGINAL LINE: ushort planes;
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: ushort bit_count;
	private short bit_count;
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: uint size_of_image;
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: uint x_pixels_per_meter;
	private int x_pixels_per_meter;

	/** 
		Contains the number of Y pixels per meter.
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: uint y_pixels_per_meter;
	private int y_pixels_per_meter;

	/** 
		Contains the number of colors used.
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: uint colors_used;
	private int colors_used;

	/** 
		Contains the number of important colors.
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: uint colors_important;
	private int colors_important;
...
///#region Constructors
	...
	*/
	...
	@Deprecated
	public BitmapInfoHeader(ByteVector data)
	{
		this(data, 0);
	}
...
//ORIGINAL LINE: public ushort getPlanes()
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public ushort getBitCount()
	...
	*/
	public ByteVector getCompressionId()
	{
...
//ORIGINAL LINE: public uint getImageSize()
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public uint getXPixelsPerMeter()
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public uint getYPixelsPerMeter()
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public uint getColorsUsed()
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public uint getImportantColors()
...
///#region IVideoCodec
	...
	*/
	...
	{
		String id = getCompressionId().toString(StringType.UTF8).toUpperCase(Locale.ROOT);
		switch (id)
		{
		case "AEMI":
		...
		case "H268":
		case "H269":
			return "Intel " + getCompressionId().toString(StringType.UTF8) + " Conferencing codec";
		case "I263":
			return "Intel I263";
		case "I420":
		...
		default:
			return String.format(CultureInfo.InvariantCulture, "Unknown Image (%1$s)", getCompressionId());
		}
	}
...
//C# TO JAVA CONVERTER TODO TASK: There is no equivalent to an 'unchecked' block in Java:
	...
	*/
	...
	{
		if (!(other instanceof BitmapInfoHeader))
		{
			return false;
		}
	...
	/** 
	 ...
	 {@link M:System.IEquatable`1.Equals }
	*/
	public boolean equals(BitmapInfoHeader other)
	{
		return size == other.size && width == other.width && height == other.height && planes == other.planes && bit_count == other.bit_count && Rasad.Core.Media.MediaMetadataManagement.ByteVector.OpEquality(compression_id, other.compression_id) && size_of_image == other.size_of_image && x_pixels_per_meter == other.x_pixels_per_meter && y_pixels_per_meter == other.y_pixels_per_meter && colors_used == other.colors_used && colors_important == other.colors_important;
	}
	...
	*/
	public static boolean OpEquality(BitmapInfoHeader first, BitmapInfoHeader second)
	{
	...
	*/
	public static boolean OpInequality(BitmapInfoHeader first, BitmapInfoHeader second)
	{
		return !first.equals(second.clone());
	}
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
///#endregion
	...
	{
		BitmapInfoHeader varCopy = new BitmapInfoHeader();

		varCopy.size = this.size;
		varCopy.width = this.width;
		varCopy.height = this.height;
		varCopy.planes = this.planes;
		varCopy.bit_count = this.bit_count;
		varCopy.compression_id = this.compression_id;
		varCopy.size_of_image = this.size_of_image;
		varCopy.x_pixels_per_meter = this.x_pixels_per_meter;
		varCopy.y_pixels_per_meter = this.y_pixels_per_meter;
		varCopy.colors_used = this.colors_used;
		varCopy.colors_important = this.colors_important;
