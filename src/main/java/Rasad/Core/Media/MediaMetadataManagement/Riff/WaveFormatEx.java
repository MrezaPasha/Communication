...
//ORIGINAL LINE: public struct WaveFormatEx : IAudioCodec, ILosslessAudioCodec
public final class WaveFormatEx implements IAudioCodec, ILosslessAudioCodec
{
...
//ORIGINAL LINE: ushort format_tag;
...
//ORIGINAL LINE: ushort channels;
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: uint samples_per_second;
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: uint average_bytes_per_second;
	private int average_bytes_per_second;

	/** 
		Contains the number of bits per sample.
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: ushort bits_per_sample;
...
///#region Public Properties
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public ushort getFormatTag()
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public uint getAverageBytesPerSecond()
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public ushort getBitsPerSample()
...
///#region IAudioCodec
	...
	*/
	...
	{
		return (int) Math.rint(average_bytes_per_second * 8d / 1000d);
	}
	...
	*/
	public String getDescription()
	{
		...
		default:
			return "Unknown Audio (" + getFormatTag() + ")";
		}
	}
...
//C# TO JAVA CONVERTER TODO TASK: There is no equivalent to an 'unchecked' block in Java:
	...
	*/
	...
	{
		if (!(other instanceof WaveFormatEx))
		{
			return false;
		}
	...
	/** 
	 ...
	 {@link M:System.IEquatable`1.Equals }
	*/
	public boolean equals(WaveFormatEx other)
	{
	...
	*/
	public static boolean OpEquality(WaveFormatEx first, WaveFormatEx second)
	{
	...
	*/
	public static boolean OpInequality(WaveFormatEx first, WaveFormatEx second)
	{
		return !first.equals(second.clone());
	}
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
///#endregion
	...
	public WaveFormatEx clone()
	{
		WaveFormatEx varCopy = new WaveFormatEx();

		varCopy.format_tag = this.format_tag;
		varCopy.channels = this.channels;
		varCopy.samples_per_second = this.samples_per_second;
		varCopy.average_bytes_per_second = this.average_bytes_per_second;
