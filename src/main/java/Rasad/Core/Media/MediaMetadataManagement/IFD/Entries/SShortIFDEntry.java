...
*/
public class SShortIFDEntry implements IFDEntry
{
...
///#region Constructors
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public SShortIFDEntry(ushort tag, short value)
	public SShortIFDEntry(short tag, short value)
	{
		setTag(tag);
		setValue(value);
	}
...
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: return ByteVector.FromUShort((ushort) Value, is_bigendian);
		return ByteVector.FromUShort((short) getValue(), is_bigendian);
	}
