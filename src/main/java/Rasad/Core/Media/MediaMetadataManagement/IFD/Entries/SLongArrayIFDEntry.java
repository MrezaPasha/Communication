...
*/
public class SLongArrayIFDEntry extends ArrayIFDEntry<Integer>
{
...
//ORIGINAL LINE: public SLongArrayIFDEntry(ushort tag, int [] values)
	public SLongArrayIFDEntry(short tag, int[] values)
	{
		super(tag);
		setValues(values);
	}
