...
*/
public class SRationalArrayIFDEntry extends ArrayIFDEntry<SRational>
{
...
//ORIGINAL LINE: public SRationalArrayIFDEntry(ushort tag, SRational [] entries)
	public SRationalArrayIFDEntry(short tag, SRational[] entries)
	{
		super(tag);
		setValues(entries);
	}
...
//ORIGINAL LINE: count = (uint) Values.Length;
		...
		for (SRational rational : getValues())
		{
			data.add(ByteVector.FromInt(rational.getNumerator(), is_bigendian));
			data.add(ByteVector.FromInt(rational.getDenominator(), is_bigendian));
		}
