...
*/
public class StringIFDEntry implements IFDEntry
{
...
///#region Constructors
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public StringIFDEntry(ushort tag, string value)
	public StringIFDEntry(short tag, String value)
	{
		setTag(tag);
		setValue(value);
	}
...
//ORIGINAL LINE: public ByteVector Render(bool is_bigendian, uint offset, out ushort type, out uint count)
	...
	{
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: type = (ushort) IFDEntryType.Ascii;
		type.argValue = (short) IFDEntryType.Ascii.getValue();

		ByteVector data = getValue();
		data.add("\0");
