...
*/
public class SShortArrayIFDEntry extends ArrayIFDEntry<Short>
{
...
//ORIGINAL LINE: public SShortArrayIFDEntry(ushort tag, short [] values)
	public SShortArrayIFDEntry(short tag, short[] values)
	{
		super(tag);
		setValues(values);
	}
...
//ORIGINAL LINE: public override ByteVector Render(bool is_bigendian, uint offset, out ushort type, out uint count)
	...
	{
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: type = (ushort) IFDEntryType.SShort;
		type.argValue = (short) IFDEntryType.SShort.getValue();
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//ORIGINAL LINE: foreach (ushort value in Values)
		...
		{
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: data.Add(ByteVector.FromUShort((ushort) value, is_bigendian));
			data.add(ByteVector.FromUShort((short) value, is_bigendian));
		}
