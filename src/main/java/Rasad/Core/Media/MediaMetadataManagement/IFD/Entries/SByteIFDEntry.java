...
*/
public class SByteIFDEntry implements IFDEntry
{
...
///#region Constructors
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public SByteIFDEntry(ushort tag, sbyte value)
	public SByteIFDEntry(short tag, byte value)
	{
		setTag(tag);
		setValue(value);
	}
...
//ORIGINAL LINE: public ByteVector Render(bool is_bigendian, uint offset, out ushort type, out uint count)
	...
	{
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: type = (ushort) IFDEntryType.SByte;
		type.argValue = (short) IFDEntryType.SByte.getValue();
		count.argValue = 1;

//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: return (byte) Value;
