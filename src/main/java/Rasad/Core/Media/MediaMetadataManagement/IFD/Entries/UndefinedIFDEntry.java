...
*/
public class UndefinedIFDEntry implements IFDEntry
{
...
///#region Constructors
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public UndefinedIFDEntry(ushort tag, ByteVector data)
	public UndefinedIFDEntry(short tag, ByteVector data)
	{
		setTag(tag);
		setData(data);
	}
