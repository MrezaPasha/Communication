...
*/
public class SLongIFDEntry implements IFDEntry
{
...
///#region Constructors
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public SLongIFDEntry(ushort tag, int value)
	public SLongIFDEntry(short tag, int value)
	{
		setTag(tag);
		setValue(value);
	}
...
//ORIGINAL LINE: public ByteVector Render(bool is_bigendian, uint offset, out ushort type, out uint count)
	...
	{
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: type = (ushort) IFDEntryType.SLong;
		type.argValue = (short) IFDEntryType.SLong.getValue();
		count.argValue = 1;

		return ByteVector.FromInt(getValue(), is_bigendian);
	}
