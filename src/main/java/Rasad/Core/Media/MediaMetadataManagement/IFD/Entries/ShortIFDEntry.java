...
*/
public class ShortIFDEntry implements IFDEntry
{
...
//ORIGINAL LINE: private void setTag(ushort value)
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: private ushort Value;
	private short Value;
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public ushort getValue()
	public final short getValue()
	{
		return Value;
	}
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: private void setValue(ushort value)
...
///#region Constructors
	...
	*/
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public ShortIFDEntry(ushort tag, ushort value)
	public ShortIFDEntry(short tag, short value)
	{
		setTag(tag);
		setValue(value);
	}
...
//ORIGINAL LINE: type = (ushort) IFDEntryType.Short;
		...
		return ByteVector.FromUShort(getValue(), is_bigendian);
	}
