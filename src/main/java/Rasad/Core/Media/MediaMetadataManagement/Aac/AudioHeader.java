...
*/
public class AudioHeader implements IAudioCodec
{
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	private static final int[] sample_rates = new int[] {96000, 88200, 64000, 48000, 44100, 32000, 24000, 22050, 16000, 12000, 11025, 8000, 7350};

	/** 
		Contains a channel table for ADTS AAC audio.
	*/
	private static final int[] channels = new int[] {0, 1, 2, 3, 4, 5, 6, 8};
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	public static final AudioHeader Unknown = new AudioHeader();
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	public final void SetStreamLength(long streamLength)
	{
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	public static boolean Find(tangible.OutObject<AudioHeader> header, Rasad.Core.Media.MediaMetadataManagement.File file, long position, int length)
	{
		...
		do
		{
			...
			{
				if (buffer.get(i) == 0xFF && buffer.get(i + 1) >= 0xF0) // 0xFFF
				{
					try
					{
						BitStream bits = new BitStream(buffer.Mid(i, 7).getData());
						...
						header.argValue = new AudioHeader(channels[channelconfigindex], (int)bitrate, (int)samplerate, (int)numberofsamples, numberofframes);
	...
	*/
	...
	{
		return Find(header, file, position, -1);
	}
