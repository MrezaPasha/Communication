package Rasad.Core.Media.MediaMetadataManagement.Tiff.Pef;
...
//ORIGINAL LINE: [SupportedMimeType("taglib/pef", "pef")][SupportedMimeType("image/pef")][SupportedMimeType("image/x-pentax-pef")] public class File : Rasad.Core.Media.MediaMetadataManagement.Tiff.File
