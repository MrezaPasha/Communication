...
///#region Public Delegates
	...
	/** 
	 ...
	 @return 
		...
		<p>In order to add support for a new Ogg codec in
		Rasad.Core.Media.MediaMetadataManagement#, a derivative class of <see cref="Codec" /> needs
		...
		cref="AddCodecProvider"/>.</p>
		<p>A method implementing <see cref="CodecProvider" />
		...
		that it needs to try anther codec provider.</p>
	 
	 <example>
		<p>The following example would check for a Speex
		packet and return a Speex codec:</p>
		<code lang="C++">
	...
	*/
	...
	{
		Codec invoke(ByteVector packet);
	}
...
///#region Private Static Fields
	...
	*/
	private static ArrayList<CodecProvider> providers = new ArrayList<CodecProvider> ();
...
///#region Private Properties
	...
	*/
	public abstract MediaTypes getMediaTypes();
	...
	*/
	public abstract ByteVector getCommentData();
...
///#region Private Methods
	...
	*/
	public abstract boolean ReadPacket(ByteVector packet, int index);
