...
//
// Original Source:
//   mpcfile.cpp from Rasad.Core.Media.MediaMetadataManagement
//
...
//ORIGINAL LINE: [SupportedMimeType("taglib/mpc", "mpc")][SupportedMimeType("taglib/mp+", "mp+")][SupportedMimeType("taglib/mpp", "mpp")][SupportedMimeType("audio/x-musepack")] public class File : Rasad.Core.Media.MediaMetadataManagement.NonContainer.File
