...
public class TMapFileUploadRequestMessage implements Serializable
{
	private MapUploadCommand Command = MapUploadCommand.values()[0];
	public final MapUploadCommand getCommand()
	{
		return Command;
	}
	public final void setCommand(MapUploadCommand value)
	{
		Command = value;
	}
	private UUID MapID;
